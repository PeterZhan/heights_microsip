...
public:
	...
	bool ContactAdd(CString number, CString name, CString type, char presence, char directory, BOOL save = FALSE, BOOL fromDirectory = FALSE);
...
private:
	...
	void ContactDecode(CString str, CString &number, CString &type, CString &name, BOOL &presence, BOOL &fromDirectory);
...
public:
	...
	afx_msg void OnLvnItemchangedContacts(NMHDR *pNMHDR, LRESULT *pResult);
};
