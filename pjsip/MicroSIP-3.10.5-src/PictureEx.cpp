...
void CPictureEx::TransparentBlt2(HDC hdcDest,      // ??DC
	int nXOriginDest,   // ??X??
	int nYOriginDest,   // ??Y??
	int nWidthDest,     // ????
	int nHeightDest,    // ????
...
/*	COLORREF crMask = RGB(0xFF, 0xFF, 0xFF);
	...
	//m_PaintRect.GetBitmap(&bm);
	int nWidth = nPaintWidth;// bm.bmWidth;
	int nHeight = nPaintHeight;*/
	/*
	BITMAP bm;
	COLORREF crMask = RGB(0xFF, 0xFF, 0xFF);
	LONG nPaintWidth = m_PaintRect.right - m_PaintRect.left;
