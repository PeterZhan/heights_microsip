...
enum EUserWndMessages
{
	...
	MYWM_SHELL_EXECUTE,
	MYWM_SET_PANE_TEXT,
	MYWM_SET_WINDOW_TEXT,
	MYWM_ADD_MESSAGE,
	MYWM_SET_VMCOUNT_TEXT,
	UM_ON_PLAYER_PLAY,
	UM_ON_CALL_STATE,
...
enum { MSIP_SOUND_STOP, MSIP_SOUND_RING, MSIP_SOUND_RINGIN, MSIP_SOUND_RINGOUT, MSIP_SOUND_CUSTOM, MSIP_SOUND_MESSAGE_IN, MSIP_SOUND_MESSAGE_OUT, MSIP_SOUND_HANGUP, MSIP_SOUND_RINGIN2 };
